    ...
    private void initView() {
     ...
     /*   powerBTN = findViewById(R.id.button_change_power);
      ...
      /*  emergencyStop = findViewById(R.id.button_emergency_stop);
        ...
        moveJEdit[3] = findViewById(R.id.move_j_r_edit);
...
*/
  ...
  /*      coordPlusBtn[4] = findViewById(R.id.coordinate_ry_plus_button);
        ...
        coordMinusBtn[3] = findViewById(R.id.coordinate_r_minus_button);
...
*/
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (v.getId()) {
            ...
            case R.id.coordinate_z_plus_button:
                pos = 14;
                break;
            case R.id.coordinate_r_plus_button:
                pos = 15;
                break;
            ...
            case R.id.coordinate_z_minus_button:
                pos = 20;
                break;
            case R.id.coordinate_r_minus_button:
                pos = 21;
                break;
            default:
                isPosTouch = false;
    ...
    public void refreshToolVectorActual(double[] toolVectorActual) {
        ...
        coordText[3].setText(  "R:" + toolVectorActual[3]);
