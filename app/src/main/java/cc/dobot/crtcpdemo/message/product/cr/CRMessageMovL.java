...
public class CRMessageMovL extends BaseMessage {
    double x,y,z,r;

    @Override
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("MovL("+x+","+y+","+z+","+r+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("MovL("+x+","+y+","+z+","+r+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("MovL("+x+","+y+","+z+","+r+")");
    }
