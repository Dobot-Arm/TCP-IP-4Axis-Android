...
public class CRMessageMovJ extends BaseMessage {
    ...
    public void constructSendData() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            this.messageContent=("MovJ("+x+","+y+","+z+","+r+")").getBytes(StandardCharsets.US_ASCII);
        }else
            this.messageContent=("MovJ("+x+","+y+","+z+","+r+")").getBytes( Charset.forName("US-ASCII"));
        this.messageStrContent=("MovJ("+x+","+y+","+z+","+r+")");
    }
